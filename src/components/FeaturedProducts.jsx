	...
	return (
		<div className='py-12'>
			<div className='container mx-auto px-4'>
				<h2 className='text-center text-3xl sm:text-4xl font-bold text-blue-600 mb-4'>Available Products</h2>
				<div className='relative'>
					<div className='overflow-hidden'>
						<div className='flex' style={{ transform: `translateX(-${currentIndex * (100 / itemsPerPage)}%)` }}>
							{featuredProducts?.map((product) => (
									<div key={product._id} className='w-full sm:w-1/2 lg:w-1/3 xl:w-1/4 flex-shrink-0 px-2'>
										<div className='bg-white rounded border border-gray-300 overflow-hidden h-full'>
											<div className='overflow-hidden'>
					...
					<button
						...
						disabled={isStartDisabled}
														...
														isStartDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
													}`}
					>
					...
					<button
						...
						className={`absolute top-1/2 -right-4 transform -translate-y-1/2 p-2 rounded-full ${
							isEndDisabled ? "bg-gray-400 cursor-not-allowed" : "bg-blue-600 hover:bg-blue-700"
						}`}
					>
